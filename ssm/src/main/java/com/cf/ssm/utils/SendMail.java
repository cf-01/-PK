...
public class SendMail {
    ...
    // 发件人的邮箱账号
    public static String sendEmailAccount = "203496423@qq.com";
    // 发件人的邮箱的授权码
    public static String sendEmailPassword = "uanhcxqywntgcafb";
    // 发件人邮箱的SMTP服务器地址
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        // 设置发件人姓名和编码格式
        message.setFrom(new InternetAddress(sendMail, "【颜值大PK系统】", "UTF-8"));
